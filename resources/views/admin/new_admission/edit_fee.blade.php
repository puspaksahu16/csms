                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="container">
                                                    ...
                                                    <form class="form" method="POST" action="{{route('admission_fee.update', $addmision_fee->id)}}">
                                                        @csrf
                                                        @method('put')
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input type="checkbox" class="custom-control-input"  {{ in_array($gf->id, $selected_general) ? "checked" : ""}} name="general[]" value="{{ $gf->id }}" id="{{$gf->name.$key}}">
                                                                        ...
                                                                        <table class="table table-striped mb-0">
                                                                            ...
                                                                            @foreach($products as $key => $p)
                                                                                <tr>
                                                                                    <td>
                                                                                        <div class="custom-control custom-checkbox">
                                                                                            <input type="checkbox" class="custom-control-input" {{ in_array($p->id, $selected_product) ? "checked" : ""}} name="product[]" value="{{ $p->id }}" id="{{$key}}">
                                                                    ...
                                                                    <table class="table table-striped mb-0">
                                                                        ...
                                                                        @foreach($extra_classes as $key => $ec)
                                                                            <tr>
                                                                                <td>
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input type="checkbox" class="custom-control-input"  {{ in_array($ec->id, $selected_classes) ? "checked" : ""}} name="ecc[]" value="{{ $ec->id }}" id="{{$ec->name.$key}}">
                                                                    ...
                                                                    <table class="table table-striped mb-0" id="">
                                                                        ...
                                                                        @foreach($book as $key => $b)
                                                                            <tr>
                                                                                <td>
                                                                                    <div class="custom-control custom-checkbox">
                                                                                        <input type="checkbox" class="custom-control-input" {{ in_array($b->id, $selected_books) ? "checked" : ""}} name="book[]" value="{{ $b->id }}" id="{{$b->name.$key}}">
