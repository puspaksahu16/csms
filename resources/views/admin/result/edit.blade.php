                        ...
                        <div class="col-6" style="margin: auto">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form" action="{{route('result.update', $result->id)}}" method="POST">
                                            @method('PUT')
                                            @csrf
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-label-group">
                                                            <input type="number" class="form-control" placeholder="Percentage"  value="{{$result->percentage}}" name="percentage">
