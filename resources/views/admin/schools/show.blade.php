                                    ...
                                    <div class="card-body">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-6">
                                                        <div class="form-label-group">
                                                            <input type="text" class="form-control" disabled placeholder="Owner Contact No" value="@if($school->subscription_type == 1) 30 Days @elseif($school->subscription_type == 2) 180 Days @elseif($school->subscription_type == 3) 360 Days @else -- @endif" name="subscription_type">
