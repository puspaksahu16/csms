...
<section id="multiple-column-form">
   ...
   <br/>
                                              scan photo:* <input type="file" name='photofile'  id="profilephoto1" onchange="readURL1(this);"/><p><br/></p>
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                            <input type="date"  class="form-control"  name="city-column">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-label-group">
                                        	...
                                        	<tr>
    <br/>
    <td><input type="radio" name="caste" value="ST">ST</td>
    <td><input type="radio" name="caste" value="SC">SC</td>
    <td><input type="radio" name="caste" value="OBC">OBC</td>
    <td><input type="radio" name="caste" value="GEN">GEN</td>
...
<div class="col-md-6 col-12">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Resedence Address</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form class="form">
