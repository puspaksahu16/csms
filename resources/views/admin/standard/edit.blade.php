                        ...
                        <div class="col-6" style="margin: auto">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form" action="{{route('standard.update', $standard->id)}}"  method="POST">
                                            @method('PUT')
                                            @csrf
                                            <div class="form-body">
                                                <div class="row">
...
{{--                                                            <input type="text" class="form-control" placeholder="Standard Name" name="name" value="{{$standard->name}}">--}}
                                                    ...
                                                    <div class="col-12 pt-2">
                                                        ...
                                                        <a href="{{url('/standard')}}"><input type="button" class="btn btn-outline-warning mr-1 mb-1" value="Back"></a>
